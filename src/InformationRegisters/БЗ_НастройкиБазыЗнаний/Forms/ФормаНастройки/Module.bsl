...
Процедура ПрочитатьНаСервере()
	ОбщиеНастройки = БЗ_БазаЗнанийКлиентСерверПовтИсп.ПолучитьСтруктуруОбщихНастроекБазыЗнаний();
	
	// Общие настройки
	НаборЗаписей = РегистрыСведений.БЗ_НастройкиБазыЗнаний.СоздатьНаборЗаписей();
