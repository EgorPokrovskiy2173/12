...
Функция ТаблицаСтилей_АйТи()
	...
	|}
	|a.action-btn-2:hover span, .action-btn-2.active span {
	|background:#fff;
	|border-right: 1px solid  rgba(0,0,0,0.3);
	|color: #297FB8;}
	|.info-gray {border:1px solid #9DB6C9; border-radius:5px; padding:5px; background-color:#F7FBFF; margin-bottom:6px;}
