...
Процедура ЗаписатьИЗакрыть(Команда)
	...
	Результат = БЗ_БазаЗнанийКлиентСервер.ПроверитьПравильностьЗаполненияИмени(ЭтотОбъект.Имя);
	Если НЕ Результат Тогда
...
Процедура Просмотр(Команда)
	...
	ТекстТаблицы = "<html>
	|" + БЗ_БазаЗнанийCSSКлиентСервер.ПолучитьТаблицуСтилей() + "
	|<style>
...
Функция ПолучитьПредставлениеHTMLНаСервере(Документ)
	...
	Возврат Справочники.БЗ_СтатьиБазыЗнаний.ПолучитьПредставлениеТаблицыВHTML(Документ);
...
Процедура ЗаписатьТабличныйДокументНаСервере()
	...
	СтруктураДок	= Справочники.БЗ_СтатьиБазыЗнаний.ПолучитьПредставлениеТаблицыВHTML(ТабличныйДокумент);
