...
Процедура ЗаполнитьПодразделыНаСервере()
	...
	МассивЭлементов = Справочники.БЗ_СтатьиБазыЗнаний.ПолучитьИерархиюОбластейСтатьи(ЭтотОбъект.СтатьяБазыЗнаний);
...
Процедура НайтиСтатьюПоИдентификаторуНаСервере(ИдентификаторПоиска)
	...
	ЭтотОбъект.СтатьяБазыЗнаний = Справочники.БЗ_СтатьиБазыЗнаний.ПолучитьСсылку(ИдентификаторСсылки);
...
Процедура НайтиКатегориюПоИдентификаторуНаСервере(ИдентификаторПоиска)
	...
	ИдентификаторСсылки = Новый УникальныйИдентификатор(ИдентификаторПоиска);
	ЭтотОбъект.КатегорияБазыЗнаний = Справочники.БЗ_КатегорииБазыЗнаний.ПолучитьСсылку(ИдентификаторСсылки);
