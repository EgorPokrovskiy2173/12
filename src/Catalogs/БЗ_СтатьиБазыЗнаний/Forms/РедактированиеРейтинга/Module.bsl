...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.Оценка = БЗ_БазаЗнаний.ПолучитьОценкуСтатьи(ЭтотОбъект.СтатьяБазыЗнаний, ЭтотОбъект.Пользователь);
...
Процедура ЗаписатьРейтингСтатьиНаСервере(СтатьяСсылка, ПользовательСсылка, Оценка)
	...
	БЗ_БазаЗнаний.ДобавитьОценкуСтатье(СтатьяСсылка, ПользовательСсылка, Оценка);
