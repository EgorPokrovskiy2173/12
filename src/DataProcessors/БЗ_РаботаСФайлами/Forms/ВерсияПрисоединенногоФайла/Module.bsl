...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(ЭтотОбъект.Объект.Владелец) = Тип("СправочникСсылка.БЗ_Файлы") Тогда
	...
	Если РасширениеФайлаВСписке Тогда
		Если ЗначениеЗаполнено(ЭтотОбъект.Объект.Ссылка) Тогда
			...
			КодировкаЗначение = РегистрыСведений.БЗ_КодировкиФайлов.КодировкаВерсииФайла(ЭтотОбъект.Объект.Ссылка);
